...
public class AppUtil {
    ...
    public static boolean isNetworkAvailable() {
        try {
            ConnectivityManager connectivity = (ConnectivityManager) RetrofitApplication.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
